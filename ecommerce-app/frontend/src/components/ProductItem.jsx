      ...
      <div className="task-content">
        <div className="task-details">
          <div className="task-title">
            {product.name}
            <span className="priority-badge priority-medium">{product.category}</span>
          </div>
          <div className="task-desc">💰 ₹{product.price} &nbsp;|&nbsp; 📦 Stock: {product.stock}</div>
          {product.description && <div className="task-desc">{product.description}</div>}
        </div>
      </div>
      <div className="task-actions">
        <button className="icon-btn" onClick={() => onEdit(product)} title="Edit Product">
        ...
        <button className="icon-btn delete" onClick={() => onDelete(product._id)} title="Delete Product">
