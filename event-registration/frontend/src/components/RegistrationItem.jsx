function RegistrationItem({ registration, onDelete, onEdit }) {
  return (
      ...
      <div className="task-content">
        <div className="task-details">
          <div className="task-title">
            {registration.name}
            <span className="priority-badge priority-high">{registration.event}</span>
          </div>
          <div className="task-desc">✉️ {registration.email} {registration.phone && `| 📞 ${registration.phone}`}</div>
          {registration.college && <div className="task-desc">🏫 {registration.college}</div>}
        </div>
      </div>
      <div className="task-actions">
        <button className="icon-btn" onClick={() => onEdit(registration)} title="Edit Registration">
        ...
        <button className="icon-btn delete" onClick={() => onDelete(registration._id)} title="Delete Registration">
